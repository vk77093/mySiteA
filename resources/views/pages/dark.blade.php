...
<div class="mr-5 ml-5 mt-4">
    <h6 class="text-bold about-us"> DARK CHOCOLATE VARIANTS </h6>
</div>
<div class="row">
<div class="col-sm-4 col-md-4 mt-4">
 ...
 <figcaption class="figure-caption text-center">
     ...
     <div class="astrodivider">
        ...
        <div class="prodDesc">
            <p class="product-desc">Product Code - 1401</p>
        <p class="product-desc">Min. cocoa 55.00%</p>
 ...
 <figcaption class="figure-caption text-center">
     ...
     <div class="astrodivider">
        ...
        <div class="prodDesc">
            <p class="product-desc">Product Code - 1407</p>
        <p class="product-desc">Min. cocoa 60.00%</p>
        <p class="product-desc">Shelf life 24 months</p>
        </div>
 ...
 <figcaption class="figure-caption text-center">
     ...
     <div class="astrodivider">
        ...
        <div class="prodDesc">
            <p class="product-desc">Product Code - 1413</p>
        <p class="product-desc">Min. cocoa 73.00%</p>
        <p class="product-desc">Shelf life 24 months</p>
        </div>
...
<section class="text-center">
    ...
    <div class="mr-5 ml-5">
    <h6 class="text-bold about-us"> ORIGIN CHOCOLATE </h6>
</div>
</div>
<div class="row">
...
<div class="container">
 ...
 <figcaption class="figure-caption text-center">
     ...
     <div class="astrodivider">
        ...
        <div class="prodDesc">
            <p class="product-desc">Product Code - 1388</p>
        <p class="product-desc">Min. cocoa 70.00%</p>
        <p class="product-desc">Shelf life 24 months</p>
        </div>
 ...
 <figcaption class="figure-caption text-center">
     ...
     <div class="astrodivider">
        ...
        <div class="prodDesc">
            <p class="product-desc">Product Code - 1406</p>
        <p class="product-desc">Min. cocoa 73.00%</p>
        <p class="product-desc">Shelf life 24 months</p>
        </div>
 ...
 <figcaption class="figure-caption text-center">
     ...
     <div class="astrodivider">
        ...
        <div class="prodDesc">
            <p class="product-desc">Product Code - 1427</p>
        <p class="product-desc">Min. cocoa 73.00%</p>
        <p class="product-desc">Shelf life 24 months</p>
        </div>
 ...
 <figcaption class="figure-caption text-center">
     ...
     <div class="astrodivider">
        ...
        <div class="prodDesc">
            <p class="product-desc">Product Code - 1440</p>
        <p class="product-desc">Min. cocoa 74.00%</p>
        <p class="product-desc">Shelf life 24 months</p>
        </div>
 ...
 <figcaption class="figure-caption text-center">
     ...
     <div class="astrodivider">
        ...
        <div class="prodDesc">
            <p class="product-desc">Product Code - 1441</p>
        <p class="product-desc">Min. cocoa 74.00%</p>
        <p class="product-desc">Shelf life 24 months</p>
        </div>
 ...
 <figcaption class="figure-caption text-center">
     ...
     <div class="astrodivider">
        ...
        <div class="prodDesc">
            <p class="product-desc">Product Code - 1442</p>
        <p class="product-desc">Min. cocoa 72.00%</p>
        <p class="product-desc">Shelf life 24 months</p>
        </div>
