...
<div class="carousel-inner">
 <div class="carousel-item active">
     <img src="{{asset('assets/images/MilkChocolates/Milk-Chocolate-Drop.jpg')}}" class="d-block w-100" alt="milk chocolate header of aariafoods">
    </div>
</div>
</div>
<div class="conatiner mt-2 mb-2">
 ...
 <figure class="figure">
 <a href="/milk-chocolates/dec-1506"><img src="{{asset('assets/images/MilkChocolates/Milk.jpg')}}" alt="MILK CHOCOLATE COUVERTURE" class="figure-img img-fluid bordered hvr-float-shadow lazy" loading="lazy"></a>
     ...
     <div class="astrodivider">
        ...
        <p class="product-desc">Shelf life 24 months</p>
                ...
                <div class="col-md-6 col-sm-6 text-center" style="margin-top: 150px">
                    ...
                    <img src="{{asset('assets/images/MilkChocolates/milkdec.jpg')}}" class="img-fluid hvr-bounce-in img-thumbnail" alt="milk chcolates description by aariafoods">
                </div>
            </div>
        </div>
    </section>
