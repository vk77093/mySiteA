...
<div class="carousel-inner">
 <div class="carousel-item active">
     <img src="{{asset('assets/images/Pastes/hazelnutHeader.jpg')}}" class="d-block w-100" alt="pistachio header for aariafoods">
    </div>
</div>
</div>
<div class="container mt-2 mb-2">
    ...
    <h6 class="about-us"> 3380-HAZELNUT 100% PASTE </h6>
</div>
    </div>
<div class="row product-top">
    <div class="col-sm-6 col-md-6 text-center product-top">
<p class="comp">Composition</p>
<span class="comp">INGREDIENTS:</span> <span class="compDesc">Hazelnut</span><br>
<span class="compDesc">Contains Allergen</span> <br>
<span class="comp ml-2">Allergen Warning : </span>
<span class="compDesc">Hazelnut. May Contain Traces of Pistachio, Almond, Walnut & Cashew.</span><br>
                   <span class="comp">*The Product Doesn’t Contain Gluten*</span>
                   <section class="mt-3">
                      <a href="/pastes/dec-3380/technical-specification-3380"><button class="btn btn-myInfo btn-lg">Click For technical specs..</button></a>
                   </section>
    </div>
...
<div class="col-sm-4">
    <div class="img hvr-float-shadow"><a href="/fillings/dec-4832"><img src="{{asset('assets/images/Fillings/Coffee-Filling-4832-Bot.jpg')}}" class="img-fluid center-block lazy" loading="lazy" alt="filling-4832"></a></div>
    <p class="text-center recip mt-2">RECIPE NO° 4832</p>
</div>
<div class="col-sm-4">
    <div class="img hvr-float-shadow"><a href="/fillings/dec-4836"><img src="{{asset('assets/images/Fillings/hazelnut-20-Bot.jpg')}}" class="img-fluid center-block lazy" loading="lazy" alt="fillings hazelnut"></a></div>
    <p class="text-center recip mt-2">RECIPE NO° 4836</p>
</div>
<div class="col-sm-4">
<div class="img hvr-float-shadow"><a href="/fillings/dec-4839"><img src="{{asset('assets/images/Fillings/yogurt-strawberry-bot.jpg')}}" class="img-fluid center-block lazy" loading="lazy" alt="fillings strawberry"></a></div>
