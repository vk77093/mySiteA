...
<div class="text-center mr-5 ml-5 mt-3">
    <h6 class="about-us">TECHNICAL SPECIFICATION FOR 4864-HAZELNUT SPREAD</h6>
</div>
</div>
<div class="row">
...
<tr>
    ...
    <td class="compDesc">4864</td>
</tr>
<tr>
    <td class="compDesc">Product Name</td>
    <td class="compDesc">Hazelnut Spread</td>
</tr>
...
<tr>
    ...
    <td class="compDesc">Sugar, Refined Sunflower Oil, Hazelnut Paste (24%), Dextrose, Cocoa Powder (22/24), Skimmed Milk Powder, Emulsifier (INS322) <br>
Contains Added Natural Flavour (Vanilla Extract)</td>
</tr>
<tr>
    <td class="compDesc">Allergen</td>
    <td class="compDesc">Milk Solids, Soy Lecithin, Hazelnut, May Contain Traces of Other Nuts in Shell. <br>
...
<p class="comp">Nutritional information per 100 g</p>
    <table class="table tableCol mt-2 text-center">
        <tr>
            ...
            <td class="compDesc">591.00 Kcal</td>
        </tr>
        <tr>
            <td class="compDesc">Proteins</td>
            <td class="compDesc">5.60 g</td>
        </tr>
        <tr>
            <td class="compDesc">Carbohydrates</td>
            <td class="compDesc">45.20 g</td>
        </tr>

        <tr>
            <td class="compDesc">Sugar</td>
            <td class="compDesc">44.30 g</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="compDesc">42.40 g</td>
        </tr>
        <tr>
            <td class="compDesc">Fiber</td>
            <td class="compDesc">3.20 g</td>
        </tr>
        <tr>
            <td class="compDesc">Sodium*</td>
            <td class="compDesc">24.00 mg</td>
        </tr>
    </table>
