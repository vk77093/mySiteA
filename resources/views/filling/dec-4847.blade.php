...
<div class="carousel-inner">
 <div class="carousel-item active">
     <img src="{{asset('assets/images/Fillings/HeaderChocoMint.jpg')}}" class="d-block w-100" alt="...">
    </div>
</div>
</div>
<div class="container mt-2 mb-2">
    ...
    <h6 class="about-us"> 4847-CHOCO-MINT FILLING </h6>
</div>
    </div>
<div class="row product-top">
    <div class="col-sm-6 col-md-6 text-center product-top">
<p class="comp">Composition</p>
<span class="comp">INGREDIENTS:</span> <span class="compDesc">Vegetable Palm Oil, Sugar, Whey Powder, Lactose, Skimmed Milk Powder, Permitted Emulsifier (INS322)</span><br>
...
<span class="compDesc">Contains Milk & Soy Lecithin, May Contains Traces of  other Nuts.</span><br>
                   ...
                   <section class="mt-3">
                      <a href="/fillings/dec-4847/technical-specification-4847"><button class="btn btn-myInfo btn-lg">Click For technical specs..</button></a>
                   </section>
    </div>
...
<div class="col-sm-4">
    <div class="img hvr-float-shadow"><a href="/fillings/dec-4856"><img src="{{asset('assets/images/Fillings/saffron-filling-Bot.jpg')}}" class="img-fluid center-block lazy" loading="lazy" alt="Responsive image"></a></div>
    <p class="text-center recip mt-2">RECIPE NO° 4856</p>
</div>
<div class="col-sm-4">
<div class="img hvr-float-shadow"><a href="/fillings/dec-4858"><img src="{{asset('assets/images/Fillings/Nut-ciock-bot.jpg')}}" class="img-fluid center-block lazy" loading="lazy" alt="Responsive image"></a></div>
