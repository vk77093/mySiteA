...
<div class="container mt-2 mb-2">
    ...
    <h6 class="about-us"> 4841-CARAMEL FILLING </h6>
</div>
    </div>
<div class="row product-top">
    <div class="col-sm-6 col-md-6 text-center product-top">
<p class="comp">Composition</p>
<span class="comp">INGREDIENTS:</span> <span class="compDesc">Vegetable Palm Oil, Sugar, Whey Powder, Lactose, Skimmed Milk Powder, Caramel, Permitted Emulsifier (INS322)</span><br>
<p class="compDesc">Contains Permitted Synthetic Food Colour (INS120) & Added Flavours (Nature-Identical)</p>
...
<span class="compDesc">Contains Milk & Soy Lecithin, May Contains Traces of  other Nuts.</span><br>
                   ...
                   <section class="mt-3">
                      <a href="/fillings/dec-4841/technical-specification-4841"><button class="btn btn-myInfo btn-lg">Click For technical specs..</button></a>
                   </section>
    </div>
