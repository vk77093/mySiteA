...
<div class="container mt-2 mb-2">
    ...
    <h6 class="about-us"> 4839-STRAWBERRY YOGURT FILLING </h6>
</div>
    </div>
...
<p class="compDesc">Contains Permitted Synthetic Food Colour (INS 120) & Added Flavours (Nature Identical)</p>
...
<span class="compDesc">Contains Milk & Soy Lecithin, May Contains Traces of  other Nuts.</span><br>
                   ...
                   <section class="mt-3">
                      <a href="/fillings/dec-4839/technical-specification-4839"><button class="btn btn-myInfo btn-lg">Click For technical specs..</button></a>
                   </section>
    </div>
