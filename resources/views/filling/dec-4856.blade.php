...
<div class="carousel-inner">
 <div class="carousel-item active">
     <img src="{{asset('assets/images/Fillings/SaffronFilling4856.jpg')}}" class="d-block w-100" alt="...">
    </div>
</div>
</div>
<div class="container mt-2 mb-2">
    ...
    <h6 class="about-us"> 4856-SAFFRON FILLING
 </h6>
</div>
    </div>
...
<p class="compDesc">Contains Permitted Natural Color(INS100i) & Added Flavour (Nature Identical)(Saffron)</p>
...
<span class="compDesc">Contains Milk & Soy Lecithin, May Contains Traces of  other Nuts.</span><br>
                   ...
                   <section class="mt-3">
                      <a href="/fillings/dec-4856/technical-specification-4856"><button class="btn btn-myInfo btn-lg">Click For technical specs..</button></a>
                   </section>
    </div>
