...
<div class="col-sm-4">
    <div class="img hvr-float-shadow"><a href=""><img src="{{asset('assets/images/DarkChocolates/1407Bot.jpg')}}" class="img-fluid center-block lazy" loading="lazy" alt="Responsive image"></a></div>
    <p class="text-center mt-2 font-weight-bold about-us">RECIPE NO° 1407</p>
</div>
<div class="col-sm-4">
    <div class="img hvr-float-shadow"><a href=""><img src="{{asset('assets/images/DarkChocolates/1413Bot.jpg')}}" class="img-fluid center-block lazy" loading="lazy" alt="Responsive image"></a></div>
    <p class="text-center mt-2 font-weight-bold about-us">RECIPE NO° 1413</p>
</div>
<div class="col-sm-4">
<div class="img hvr-float-shadow"><a href=""><img src="{{asset('assets/images/DarkChocolates/1388Bot.jpg')}}" class="img-fluid center-block lazy" loading="lazy" alt="Responsive image"></a></div>
<p class="text-center mt-2 font-weight-bold about-us">RECIPE NO° 1388</p>
</div>
    </div>
</div>
</div>
