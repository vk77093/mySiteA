...
<div class="text-center mr-5 ml-5 mt-3">
    <h6 class="about-us">TECHNICAL SPECIFICATION FOR DC-1413</h6>
</div>
</div>
<div class="row">
...
<p class="comp">Nutritional information per 100 g</p>
    <table class="table tableCol mt-2 text-center">
        <tr>
            ...
            <td class="compDesc">577.00 Kcal</td>
        </tr>
        <tr>
            <td class="compDesc">Proteins</td>
            <td class="compDesc">7.50 g</td>
        </tr>
        <tr>
            <td class="compDesc">Carbohydrates</td>
            <td class="compDesc">32.00 g</td>
        </tr>
        <tr>
            <td class="compDesc">Sugar</td>
            <td class="compDesc">26.70 g</td>
        </tr>
        <tr>
            <td class="compDesc">Saturated fatty acids</td>
            <td class="compDesc">27.40 g</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="compDesc">11.40 g</td>
        </tr>
        <tr>
            <td class="compDesc">Sodium*</td>
            <td class="compDesc">2.80 mg</td>
        </tr>
    </table>
