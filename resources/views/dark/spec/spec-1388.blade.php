...
<div class="text-center mr-5 ml-5 mt-3">
    <h6 class="about-us">TECHNICAL SPECIFICATION FOR 1388 –DC SANTO DOMINGO</h6>
</div>
</div>
<div class="row">
...
<tr>
    ...
    <td class="compDesc">Sugar, Cocoa Butter, Santo Domingo Cocoa Mass,Emulsifier (INS322) <br>
...
<p class="comp">Nutritional information per 100 g</p>
    <table class="table tableCol mt-2 text-center">
        <tr>
            ...
            <td class="compDesc">626.00 Kcal</td>
        </tr>
        <tr>
            <td class="compDesc">Proteins</td>
            <td class="compDesc">6.50 g</td>
        </tr>
        <tr>
            <td class="compDesc">Carbohydrates</td>
            <td class="compDesc">43.70 g</td>
        </tr>
        <tr>
